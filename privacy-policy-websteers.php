...
<main>
    <section class="privacy-policy-top">
        <div class="container">
            <div class="privacy-policy-top-text">
                <p>Privacy policy</p>
                <p></p>
            </div>
        </div>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Websteers Ltd, 5 Nathaniel
                        Crescent, Brampton.</p>
                </li>
                <li>
...
$(document).ready(function() {
    ...
    $(".privacy-policy-top-text p:last-child").text("Last Updated: " + currentMonth + " " + currentYear);
});
</script>

...
<main>
    <section class="terms-condition-top">
        <div class="container">
            <div class="terms-condition-top-text">
    ...
    <section class="terms-condition-main">
        <div class="container">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Websteers.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Websteers, accessible from <a href="http://websteers.free.nf/"
                            rel="external nofollow noopener" target="_blank">http://websteers.free.nf/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By visiting this page on our website: <a href="http://websteers.free.nf/contact-us-websteers.php"
                            rel="external nofollow noopener"
                            target="_blank">http://websteers.free.nf/contact-us-websteers.php</a></p>
                </li>
                <li>
                    <p>By phone number: +1 437-973-7783</p>
                </li>
            </ul>
        </div>
    </section>
...
$(document).ready(function() {
    ...
    // Display the current month in the h1 element
    $(".terms-condition-top-text p:last-child").text("Last Updated: " + currentMonth + " " + currentYear);
});
</script>
